...
if (! function_exists('asset_public')) {
    ...
    */
    ...
    {
        return env('FRONT_PUBLIC', 'http://smartgroup-demo.com/future/public/') . $path;
    }
}
if (! function_exists('image')) {
    ...
    {
        return env('FRONT_PUBLIC_ST ORAGE', 'http://smartgroup-demo.com/future/storage/images/') . $path;
    }
}
