...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2021 at 09:52 AM
...
CREATE TABLE `events` (
  ...
  `time_en` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `time_ar` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'future', 'future@gmail.com', NULL, '$2y$10$zIAF2rMiXrM86gj/9T4nIO5B/fy3aA9SGXOUjZ7Q2lbJHRmeOJoEa', NULL, NULL, NULL, NULL, NULL, '2021-01-18 08:08:44', '2021-01-18 08:08:44');
...
ALTER TABLE `teaching_staff`
  ADD PRIMARY KEY (`id`),
  ADD KEY `teaching_staff_created_by_index` (`created_by`);
